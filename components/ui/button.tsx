  ...
  ({ className, variant = 'default', size = 'default', ...props }, ref) => {
    return (
      <button
        className={cn(
          // 기본 스타일 + 모바일 터치 최적화
          'inline-flex items-center justify-center rounded-lg text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 touch-manipulation',
          {
            ...
            'min-h-[40px] sm:min-h-0 h-auto sm:h-9 rounded-lg px-3 py-2 sm:py-1.5': size === 'sm',
            'min-h-[48px] sm:min-h-0 h-auto sm:h-11 rounded-lg px-8 py-3 sm:py-2': size === 'lg',
